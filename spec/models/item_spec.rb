  ...
  describe "商品新規登録" do
    ...
    context "新規登録できない時" do
      it "商品コードが空では登録できない" do
        @item.code = ""
        @item.valid?
        expect(@item.errors.full_messages).to include "Codeを入力してください"
      end  
      it "商品名が空では登録できない" do
        @item.name = ""
        @item.valid?
      ...
      it "商品在庫が空では登録できない" do
        @item.stock_num = ""
        @item.valid?
        expect(@item.errors.full_messages).to include "Stock numを入力してください"
      end 
      it "商品コードが全角では登録できない" do
        @item.code = "０００"
        @item.valid?
        expect(@item.errors.full_messages).to include "Codeは半角英数を使用してください"
      end 
      ...
      it "商品在庫が全角では登録できない" do
        @item.stock_num = "０"
        @item.valid?
        expect(@item.errors.full_messages).to include "Stock numは半角数字を使用してください"
      end
